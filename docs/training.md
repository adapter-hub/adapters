...
Finally, we switch the `Trainer` class built into Transformers for adapters' [`AdapterTrainer`](adapters.trainer.AdapterTrainer) class that is optimized for training adapter methods.
