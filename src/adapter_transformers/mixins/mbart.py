...
class MBartAttentionAdaptersMixin:
    """Adds adapters to the MBartAttention module."""
...
class MBartEncoderLayerAdaptersMixin:
    """Adds adapters to the MBartEncoderLayer module of MBART."""
...
class MBartDecoderLayerAdaptersMixin(MBartEncoderLayerAdaptersMixin):
    """Adds adapters to the MBartDecoderLayer module of MBART."""
...
class MBartEncoderAdaptersMixin(InvertibleAdaptersMixin):
    """Adds adapters to the MBartEncoder module of MBART."""

    def hook_after_embeddings(self, hook_fn: Callable):
        return self.layernorm_embedding.register_forward_hook(hook_fn)


class MBartDecoderAdaptersMixin:
    """Adds adapters to the MBartDecoder module of MBART."""
...
class MBartModelAdaptersMixin(EmbeddingAdaptersMixin, InvertibleAdaptersWrapperMixin, ModelBaseAdaptersMixin):
    """Adds adapters to the MBartModel class."""
...
class MBartDecoderWrapperAdaptersMixin(EmbeddingAdaptersWrapperMixin, ModelBaseAdaptersMixin):
    """Adds adapters to the MBartDecoderWrapper class."""
...
class MBartModelWithHeadsAdaptersMixin(EmbeddingAdaptersWrapperMixin, ModelWithHeadsAdaptersMixin):
    pass
