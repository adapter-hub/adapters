...
class LoRALayer(AdapterLayerBase):
    ...
    def average_adapter(
        ...
        **kwargs
        ...
        # TODO: What happens when IA3 is used?
        # TODO: IA3 is also mentioned with a different composition mode in the Zhang et al. (2023) paper.
        ...
        if self.add_adapter(adapter_name, self.layer_idx):
            ...
            elif combine_strategy == "lora_linear_zhang":
