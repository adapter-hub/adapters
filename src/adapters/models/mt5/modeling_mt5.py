...
class MT5LayerFFWithAdapters(T5FFLayerAdaptersMixin, MT5LayerFF):
...
class MT5AttentionWithAdapters(T5AttentionAdaptersMixin, MT5Attention):
    def forward(
        self,
        hidden_states,
        mask=None,
...
class MT5LayerSelfAttentionWithAdapters(T5SelfAttentionLayerAdaptersMixin, MT5LayerSelfAttention):
    def forward(
        self,
        hidden_states,
        attention_mask=None,
...
class MT5LayerCrossAttentionWithAdapters(T5CrossAttentionLayerAdaptersMixin, MT5LayerCrossAttention):
    def forward(
        self,
        hidden_states,
        key_value_states,
...
class MT5StackWithAdapters(T5StackAdaptersMixin, MT5Stack):
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
