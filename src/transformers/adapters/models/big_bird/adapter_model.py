...
from ....models.big_bird.modeling_big_bird import (
...
@add_start_docstrings(
    """BigBird Model transformer with the option to add multiple flexible heads on top.""",
    BIG_BIRD_START_DOCSTRING,
)
class BigBirdAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, BigBirdPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        # BERT & BIGBIRD return the pooled output as second item, we don't need that in these heads
        if not return_dict:
