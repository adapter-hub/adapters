...
from transformers import BertConfig, BertTokenizer, AutoModelWithHeads, EvalPrediction
...
model_name_or_path = "bert-base-uncased" # "roberta-large"
adapter_name_or_path = "csqa"
...
# Stringfy
data_path = str('/home/convei_intern1/adapter/data/commonsenseqa')
tokenizer_path = str('/home/convei_intern1/adapter/tokenizers/commonsenseqa/hello_mutiple_choice')
config_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
model_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
model_name_or_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
adapter_model_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
adapter_name_or_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
adapter_config_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
adapter_config_name_or_path = str('/home/convei_intern1/adapter/models/hello_mutiple_choice1')
